 ...
 */
export function extract_jar(path: string): ExtractionInfo | null {
	...
	for (var i = 0; i < num_cd_records; i++) {
		...
		switch (compression_method) {
			case (CompressionMethod.STORE): {
                //DEBUG CODE
                decomp.info("Compression Method: STORE");
			...
			case (CompressionMethod.DEFLATE): {
                //DEBUG CODE
                decomp.info("Compression Method: DEFLATE");
				var infl;
				try {
			...
			case (CompressionMethod.BZIP2): {
                //DEBUG CODE
                decomp.info("Compression Method: BZIP2");
			...
			case (CompressionMethod.LZMA): {
                //DEBUG CODE
                decomp.info("Compression Method: LMZA");
			...
			default: {
                //DEBUG CODE
                decomp.info("Compression Method: Not implemented");
